...
<html>
	...
	<body>
		...
		<div class="documento"><h2><strong>CONSTANCIA DE COMPORTAMIENTO</strong></h2></div></br>
		<p class="principal">
	...
	$html .=' <strong>N° '.$cedulaAlumno.'</strong>, natural  de  la  ciudad  de <strong>'.$ciudad.'</strong>, estado <strong>'.$estado.'</strong>, cursó el <strong>'.$descripcionGrado.'</strong> de  Educación ';
	...
	$html .= ' durante el año escolar <strong>'.$periodo.'</strong>, presentando una conducta: <strong>'.$descripcionComportamiento.'</strong>, durante  su permanencia en esta institución.<br><br></p>
		<p class="principal">
...
$dompdf->stream("Constancia Comportamiento -".$nombreAlumno." ".$apellidoAlumno.".pdf", array("Attachment" => 0));
