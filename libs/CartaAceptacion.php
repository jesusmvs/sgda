...
<html>
	...
	<body>
		...
		<div class="documento"><h2><strong>CONSTANCIA DE ACEPTACIÓN</strong></h2></div></br>
		<p class="principal">
	...
	$html .=' <strong>N°: '.$cedulaAlumno.'</strong> de <strong>'.$edad.'</strong> años de edad, natural  de  la  ciudad  de: <strong>'.$ciudad.'</strong>, estado: <strong>'.$estado.'</strong>; 
	Es ';
	if ($idSexo == 1) {
	 	$html .= 'aceptado';
	 } else{
	...
	$html .= ' en la institución para cursar el <strong>'.$descripcionGrado.'</strong> de  Educación ';
	...
	$html .= ' en el periodo escolar <strong>'.$periodo.'</strong>.<br><br></p>
		<p class="principal">
...
$dompdf->stream("Carta Aceptación -".$nombreAlumno." ".$apellidoAlumno.".pdf", array("Attachment" => 0));
