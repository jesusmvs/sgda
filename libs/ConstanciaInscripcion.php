...
<html>
	...
	<body>
		...
		<div class="documento"><h2><strong>CONSTANCIA DE INSCRIPCIÓN</strong></h2></div></br>
		<p class="principal">
	...
	$html .=' <strong>N° '.$cedulaAlumno.'</strong>, natural  de  la  ciudad  de <strong>'.$ciudad.'</strong>, estado <strong>'.$estado.'</strong>, fue';
	...
	$html .= ' para cursar el <strong>'.$descripcionGrado.'</strong> de  Educación ';
...
$dompdf->stream("Constancia Inscripcion -".$nombreAlumno." ".$apellidoAlumno.".pdf", array("Attachment" => 0));
