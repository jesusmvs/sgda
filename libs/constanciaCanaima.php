...
<html>
	...
	<body>
		...
		<div class="documento"><h2><strong>CONSTANCIA DE ENTREGA DE EQUIPO CANAIMA</strong></h2></div></br>
		<p class="principal">
	...
	$html .= ' en el periodo escolar <strong>'.$periodo.'</strong>, le fue entregado un equipo Canaima,
	serial Nº <strong>'.$serialCanaima.'</strong> tal como consta en el contrato de donación presentado por el representante.<br></p>
		<p class="principal">
...
$dompdf->stream("Constancia Canaima -".$nombreAlumno." ".$apellidoAlumno.".pdf", array("Attachment" => 0));
